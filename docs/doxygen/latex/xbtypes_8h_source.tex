...
\label{xbtypes_8h_source}\index{/mnt/1Tdata/xbase/xbase64-\/4.1.11/src/include/xbtypes.h@{/mnt/1Tdata/xbase/xbase64-\/4.1.11/src/include/xbtypes.h}}
...
\DoxyCodeLine{30 }
\DoxyCodeLine{31 \textcolor{preprocessor}{\#define xbOn       1}}
\DoxyCodeLine{32 \textcolor{preprocessor}{\#define xbOff      0}}
\DoxyCodeLine{33 \textcolor{preprocessor}{\#define xbSysDflt -\/1}}
\DoxyCodeLine{34 }
\DoxyCodeLine{35 }
\DoxyCodeLine{36 \textcolor{preprocessor}{\#ifdef HAVE\_\_FILENO\_F}}
\DoxyCodeLine{37 \textcolor{preprocessor}{  \#define xbFileNo \_fileno}}
\DoxyCodeLine{38 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{39 \textcolor{preprocessor}{  \#define xbFileNo fileno}}
\DoxyCodeLine{40 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{41 }
\DoxyCodeLine{42 \textcolor{preprocessor}{\#ifdef XB\_LOCKING\_SUPPORT}}
\DoxyCodeLine{43 \textcolor{preprocessor}{ \#if defined( HAVE\_LONG\_LONG )}}
\DoxyCodeLine{44 \textcolor{preprocessor}{  \#define LK4026531839 4026531839LL}}
\DoxyCodeLine{45 \textcolor{preprocessor}{  \#define LK4026531838 4026531838LL}}
\DoxyCodeLine{46 \textcolor{preprocessor}{  \#define LK3026531838 3026531838LL}}
\DoxyCodeLine{47 \textcolor{preprocessor}{  \#define LK1000000000 1000000000LL}}
\DoxyCodeLine{48 \textcolor{preprocessor}{ \#else}}
\DoxyCodeLine{49 \textcolor{preprocessor}{  \#define LK4026531839 4026531839L}}
\DoxyCodeLine{50 \textcolor{preprocessor}{  \#define LK4026531838 4026531838L}}
\DoxyCodeLine{51 \textcolor{preprocessor}{  \#define LK3026531838 3026531838L}}
\DoxyCodeLine{52 \textcolor{preprocessor}{  \#define LK1000000000 1000000000L}}
\DoxyCodeLine{53 \textcolor{preprocessor}{ \#endif}}
\DoxyCodeLine{54 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{55 }
\DoxyCodeLine{56 }
\DoxyCodeLine{57 }
\DoxyCodeLine{58 \}  \textcolor{comment}{/* namespace */}}
\DoxyCodeLine{59 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{/*  \_\_XB\_XTYPES\_H\_\_  */}\textcolor{preprocessor}{}}
